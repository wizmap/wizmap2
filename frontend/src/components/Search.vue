    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css">
        ...
        <div class="modal-favorite-container" @click="preventClose">
          ...
          <div class="modal-btn">
            ...
            <div class="modal-btn">
            <router-link to="/history" id="history-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
