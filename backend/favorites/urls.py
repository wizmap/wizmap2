...
from .views import ListView, ListCreateView, ListUpdateView, ListDeleteView, MyPinCreateView, MyPinUpdateView, MyPinDeleteView,FavoritesView,QuickView,QuickUpdateView,QuickDeleteView,QuickCreateView,LikeView, ListLikeView, ListUnLikeView
...
urlpatterns = [
    ...
    path('list/like/', ListLikeView.as_view(), name='list-like'),
    path('list/unlike/<int:list_id>/', ListUnLikeView.as_view(), name='list-unlike'),
